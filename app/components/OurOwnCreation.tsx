...
export default function OurOwnCreation() {
  return (
    <section className="hidden lg:block w-full max-w-[1920px] mx-auto px-6 py-10 lg:px-10 xl:px-[150px] lg:py-20">
       <div className="grid grid-cols-4 gap-8 h-[600px]">
          ...
          {/* Card 2: Action */}
          <div className="bg-[#D9D9D9] rounded-[10px] relative">
          ...
          {/* Card 3: Placeholder */}
          <div className="bg-[#D9D9D9] rounded-[10px]"></div>
